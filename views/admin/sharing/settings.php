<section class="<?php echo esc_attr('themeDev-social-body');?>">
	<div class="header-settings">
		...
		<h2 class="title"><?php echo esc_html__('Next Sharing Panel', 'themedev-social-services');?></h2>
	</div>
	<div class="nav-settings">
		<?php require ( NEXT_SOCIAL_FEED_PLUGIN_PATH.'views/admin/sharing/tab-menu-settings.php' );?>
	</div>
