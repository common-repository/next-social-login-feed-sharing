<div class="next-social-login-widget">
	<p>
		<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Share Title :' , 'themedev-social-services' ) ?> </label>
		...
		<select class="widefat" id="<?php echo $this->get_field_id( 'style' ); ?>" name="<?php echo $this->get_field_name( 'style' ); ?>">
			...
			<?php
			 foreach( $this->login_style as $k=>$v):
				if( in_array($k, ['button1', 'button2', 'button3', 'button4', 'button5', 'button6', 'button7', 'button8', 'button9', 'button10', 'button11', 'button12']) ):
			?>
